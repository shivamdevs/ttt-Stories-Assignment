...
function Footer() {
    return (
        <footer className="mt-5 border-t border-t-gray-200 border-dashed text-center space-y-5 p-5 text-gray-500 font-bold">
            ...
            <div className="">© 2023 • Terribly Tiny Tales • MyOasis Tech</div>
        </footer>
    )
}
